/*************************************************************************
   ...
   FUNCTION: 4G testing with HTTP call to a url and send SMS.
   ...
   SIMCARD: 4G/5G sim cards from Airtel/Vodaphone/Jio/BSNL can be used. 
            To test HTTP request ensure you have data plan and sms pack. 
   
   IMPORTANT: Configure the APN accordingly as per your Sim provider. 
              You can find APN settings section in below code.
   ...
   ------------------------------------------
   01/07/2025 -    1.0.0       -    Initial release of sample script.
...
/*************************************************************************
  PHONE: You can add multiple phone number to get SMS
         Uncomment below lines to add more phone numbers
*************************************************************************/
#define SMS_TARGET1  "8747866999" //Enter you phone number to which you would like to recevied SMS
...
/*************************************************************************
  CLOUD:  API/Callback url to send your data to cloud. 
          In this example we have used "Pipedream" which will allow to 
          create a dummy API call back URL and send data for testing purpose. 
          Create your free account on Pipedream website and deploy a call back URL 
          and assign that url to this variable.
*************************************************************************/
...
/*************************************************************************
  LIBRARIES: Key libraries required for 4G module, JSON Object and SPI
  
  ARDUINO: IDE version 2.2.1 and above and note the supported library versions below 
*************************************************************************/
...
//Jio specific message centre number setting not required for now as the module supports 5G Sim cards now.
...
// }
  ...
  /******************************************************************************************
      ...
      GNSS: Enabling GPS/GNSS onboard.
      The below code runs only if the 4G module supports GPS/GNSS
      so it is safe to ignore if you are testing 4G module without GPS.
